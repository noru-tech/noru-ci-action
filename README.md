...
>
> `uses: noru-tech/noru-ci-action@v0.9.0` and
> `uses: noru-tech/noru-grc-engineering/.github/actions/noru-ci@v0.9.0`
...
the [toolkit README](https://github.com/noru-tech/noru-grc-engineering/blob/v0.9.0/README.md#pieces).
...
are in [`docs/ci-mode.md`](https://github.com/noru-tech/noru-grc-engineering/blob/v0.9.0/docs/ci-mode.md).
...
| `exit-code` | The orchestrator's exit code; the table is in [`docs/ci-mode.md`](https://github.com/noru-tech/noru-grc-engineering/blob/v0.9.0/docs/ci-mode.md#exit-codes) |
...
[changelog](https://github.com/noru-tech/noru-grc-engineering/blob/v0.9.0/CHANGELOG.md).
